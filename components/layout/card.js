            ...
            <div className="personnel-info">
                ...
                <div className="user-symbol-link">
                    ...
                    <div  className="personnel-social-link">
                        <button class="youtube-dot"><img src="img/logos_youtube-icon.png" className="social-link-icon"></img></button>
                        <button class="dot"><img src="img/logos_telegram.png" className="social-link-icon"></img></button>
                        <button class="dot"><img src="img/logos_twitter.png" className="social-link-icon"></img></button>
                    </div>
                </div>
            </div>
