          ...
          <Nav className="flex-column pt-2">
            ...
            <Nav.Item className="active below-menu-item-list">
              <Nav.Link href="/campaigns" className="menu-item-area">
                <img src="/img/compaign_icon.png" className="menu-item"></img>
            ...
            <Nav.Item className="active below-menu-item-list">
              <Nav.Link href="/" className="menu-item-area">
                <img src="/img/profile_icon.png" className="menu-item"></img>
            ...
            <Nav.Item className="activem below-menu-item-list">
              <Nav.Link href="/" className="menu-item-area">
                <img
                  src="/img/medical-icon_i-billing.png"
                  className="menu-item"
                ></img>
            ...
            <Nav.Item className="active below-menu-item-list">
              <Nav.Link href="/" className="menu-item-area">
                <img
                  src="/img/eos-icons_trusted-organization.png"
                  className="menu-item"
                ></img>
            ...
            <Nav.Item className="activem below-menu-item-list">
              <Nav.Link href="/" className="menu-item-area">
                <img src="/img/carbon_settings.png" className="menu-item"></img>
                <span className="menu-item-subject">Settings</span>
              </Nav.Link>
            </Nav.Item>
            <Nav.Item className="activem below-menu-item-list">
              <Nav.Link href="/" className="menu-item-area">
                <img src="/img/bx_help-circle.png" className="menu-item"></img>
                <span className="menu-item-subject">Help Center</span>
              </Nav.Link>
            </Nav.Item>
            <Nav.Item className="activem log-out-item-list">
              <Nav.Link href="/" className="menu-item-area">
                <img src="/img/bx_log-out.png" className="log-out-item"></img>
